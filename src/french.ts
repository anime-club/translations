export const text: text = {
  ...
  thisIsACustomOrderNotAReadyMadeProduct: `Vous commandez une création sur mesure, pas un produit fini`,
  ...
  takeCustomRequests: `(en) Take custom requests`,
  sellDownloadableContent: `(en) Sell downloadable content`,
  digitalDownloadsExamples: `(en) Brushes, assets, tutorials & more`,
