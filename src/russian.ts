...
Социальная сеть`,
  ...
  orderAOneOfAKindCustomPieceCraftedToMatchYourVision: `Закажите уникальную работу, созданную специально по вашему замыслу`,
  youAreCoveredIfThereIsAProblem: `Вы защищены! Если возникнет проблема и претензия окажется обоснованной, вы получите полный возврат средств`,
