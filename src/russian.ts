export const text: text = {
  ...
  emailAlreadyUsedByAnotherAccount: `Электронная почта уже используется другой учётной записью`,
  emailSubscription: `Подписка по электронной почте`,
  ...
  no: `нет`,
  noAddedFavoriteArts: `нет добавленных артов в избранное`,
