export const text: text = {
  ...
  addOnsAreOptionalEnhancementsToYourProduct: `Dịch vụ bổ sung là những tùy chọn giúp nâng cao sản phẩm của bạn`,
  addOnsHelpBoostIncome: `Dịch vụ bổ sung giúp người mua tùy chỉnh đơn hàng và có thể tăng thu nhập của bạn`,
  addSignInVia: `Thêm đăng nhập qua`,
  addToCart: `Thêm vào giỏ hàng`,
  adoptable: `Nhân vật adoptable`,
  advancedOptions: `Tùy chọn nâng cao`,
  agreedRevisionsWereNotCompleted: `Các chỉnh sửa đã thống nhất chưa được hoàn thành`,
  aiGeneratedImagesAndNeuralNetworkFiltersAreProhibited: `Cấm sử dụng hình ảnh do AI tạo ra và bộ lọc mạng nơ-ron`,
  alertsAndWidgets: `Cảnh báo và tiện ích`,
  all: `Tất cả`,
  ...
  anAccountAlreadyUsesThisEmailSignInThenConnect: `Đã có tài khoản dùng địa chỉ email này. Hãy đăng nhập theo cách bạn vẫn dùng, rồi kết nối nhà cung cấp này trong cài đặt tài khoản`,
  anAccountAlreadyUsesThisEmailSignInWithPasskeyThenConnect: `Đã có tài khoản dùng địa chỉ email này. Hãy đăng nhập bằng khóa truy cập của bạn, chúng tôi sẽ kết nối nhà cung cấp này cho bạn`,
  anAccountAlreadyUsesThisEmailSignInWithThenConnect: (...v) =>
    `Đã có tài khoản dùng địa chỉ email này. Hãy đăng nhập bằng ${v[0]}, chúng tôi sẽ kết nối nhà cung cấp này cho bạn`,
  animationAndVideo: `Hoạt ảnh và video`,
  ...
  animeDotclubNeverAsksForYourRecoveryCodes: `Anime.club không bao giờ yêu cầu mã phục hồi của bạn`,
  ...
  artworkPublished: `Đã đăng tác phẩm`,
  ...
  avatarsAndModels: `Avatar và mô hình`,
  awaitingClientReview: `Đang chờ khách hàng xem xét`,
  awaitingSeller: `Chờ người bán`,
  awaitingSellersResponse: `Đang chờ người bán phản hồi`,
  back: `Quay lại`,
  backgroundAndDesign: `Phông nền và thiết kế`,
  badges: `Huy hiệu`,
  ...
  buyNow: `Mua ngay`,
  byContinuingYouAgreeToOur: `Khi tiếp tục, bạn đồng ý với`,
  cancel: `hủy`,
  canceled: `Đã hủy`,
  cancelOrder: `Hủy đơn hàng`,
  cannotStartWithChars: `Không thể bắt đầu bằng s{:"^$*[]{}()?-"!@#%&/,><':;|~\`"`,
  cantFindTheRightCategoryTellUsWhatYouWouldLikeUsToAdd: `Không tìm thấy danh mục phù hợp? Hãy cho chúng tôi biết bạn muốn bổ sung gì.`,
  cantSignIn: `Không đăng nhập được?`,
  categoryAndSubcategory: `Danh mục và danh mục con`,
  categoryAndTerms: `Danh mục và điều khoản`,
  change: `Thay đổi`,
  ...
  characterAndChibi: `Nhân vật và chibi`,
  chat: `Trò chuyện`,
  ...
  chooseTheCategoryAndSubcategoryThatBestDescribeYourProductThenSetClearTermsForBuyers: `Chọn danh mục và danh mục con mô tả chính xác nhất sản phẩm của bạn, sau đó đặt ra các điều khoản rõ ràng cho người mua.`,
  city: `Thành phố`,
  clearAll: `Xóa tất cả`,
  ...
  clickToAddANote: `Nhấp để thêm ghi chú`,
  close: `Đóng`,
  color: `Màu sắc`,
  ...
  commercialUsePrice: `Giá sử dụng thương mại`,
  commission: `Đơn đặt vẽ`,
  commissionPublished: `Đã đăng dịch vụ commission`,
  ...
  continue: `Tiếp tục`,
  continueWithFingerprintOrFace: `Đăng nhập bằng dấu vân tay hoặc khuôn mặt`,
  ...
  country: `Quốc gia`,
  cover: `Bìa`,
  createAddOnsForYourProduct: `Tạo dịch vụ bổ sung cho sản phẩm của bạn`,
  ...
  describeTheDetailsOfYourAddOn: `Mô tả chi tiết về dịch vụ bổ sung của bạn`,
  ...
  discard: `Bỏ thay đổi`,
  discoverAnimeArtAndArtistsFromAroundTheWorld: `Khám phá nghệ thuật anime và các họa sĩ từ khắp thế giới trên Anime.club. Theo dõi nhà sáng tạo, ủng hộ tác phẩm, khám phá tranh gốc hoặc chia sẻ tác phẩm của bạn`,
  displayName: `Tên hiển thị`,
  disputed: `Tranh chấp`,
  documentation: `Tài liệu`,
  donations: `Quyên góp`,
  done: `Đã xong`,
  doNotShareYourRecoveryCodesWithAnyone: `Không chia sẻ mã phục hồi của bạn với bất kỳ ai`,
  download: `Tải xuống`,
  ...
  eachProfileHasItsOwnArtShopAndFollowers: `Mỗi hồ sơ có tác phẩm, cửa hàng và người theo dõi riêng. Một lần đăng nhập dùng cho tất cả`,
  earlier: `Sớm hơn`,
  ...
  emotesAndStickers: `Emote và nhãn dán`,
  emotesAndStreamAssets: `Emote và tài nguyên livestream`,
  ...
  enterTheAddressAssociatedWithYourAccount: `Nhập địa chỉ liên kết với tài khoản của bạn, chúng tôi sẽ gửi email một mã để đăng nhập và thiết lập khóa truy cập mới`,
  enterYourPassword: `Nhập mật khẩu của bạn`,
  error: `Lỗi`,
  errorPleaseContactCustomerSupport: `Lỗi! Vui lòng liên hệ bộ phận hỗ trợ khách hàng...`,
  eventGraphics: `Đồ họa sự kiện`,
  ...
  files: `Tệp`,
  filesAreCorruptedOrUnusable: `Tệp bị hỏng hoặc không thể sử dụng`,
  ...
  getStarted: `Bắt đầu`,
  graphicsAndBranding: `Đồ họa và nhận diện thương hiệu`,
  ...
  ifYouLoseItYoullNeedASecondWayToGetBackIn: `Bạn chỉ có một cách đăng nhập. Nếu mất nó, bạn sẽ cần cách thứ hai để vào lại tài khoản: thêm một khóa truy cập khác, hoặc lưu một bộ mã phục hồi`,
  ...
  imageAnimation: `Hoạt ảnh hình ảnh`,
  ...
  legal: `Pháp lý`,
  legalIntro: `Đọc các tài liệu pháp lý điều chỉnh anime.club và giải thích cách xử lý thông tin cá nhân`,
  ...
  logoAndBrandDesign: `Thiết kế logo và nhận diện thương hiệu`,
  logOut: `Đăng xuất`,
  ...
  mixingAndMastering: `Mixing và mastering`,
  mobileApp: `Ứng dụng di động`,
  modelArt2D: `Minh họa mô hình 2D`,
  models3D: `Mô hình 3D`,
  monthly: `Hàng tháng`,
  moreFrom: (...v) => `Thêm từ ${v[0]}`,
  musicAndAudio: `Âm nhạc và âm thanh`,
  musicAndShortFormVideo: `Âm nhạc và video ngắn`,
  mustBeNChars: (...v) => `Phải là ${v[0]} ký tự`,
  myPayments: `Thanh toán của tôi`,
  myProfile: `Hồ sơ của tôi`,
  mySettings: `Cài đặt của tôi`,
  name: `Tên`,
  namePasskey: `Đặt tên khóa truy cập`,
  nameYourDevicesToTellThemApart: `Đặt tên cho thiết bị để dễ phân biệt`,
  ...
  noteOnlyVisibleToYou: `Ghi chú (chỉ bạn nhìn thấy)`,
  notes: `Ghi chú`,
  ...
  offerOptionalAddOns: `Cung cấp dịch vụ bổ sung như <b>giao nhanh</b>, <b>thêm nhân vật</b> hoặc <b>phông nền chi tiết</b>`,
  online: `Trực tuyến`,
  ...
  openDisputeChat: `Mở cuộc trò chuyện tranh chấp`,
  openDisputeGuidance: `Hãy giải thích rõ vấn đề của đơn hàng và cách giải quyết bạn mong muốn. Sau khi bạn mở tranh chấp, chúng tôi sẽ tạo một cuộc trò chuyện nhóm với bạn, người bán và bộ phận hỗ trợ anime.club. Cả hai bên đều có thể cung cấp bằng chứng tại đó. Bộ phận hỗ trợ có thể truy cập thông tin đơn hàng và tất cả tệp đã được chia sẻ với đơn hàng.`,
  ...
  originalAnimation: `Hoạt ảnh nguyên bản`,
  originalMusic: `Nhạc nguyên bản`,
  otherOrderIssue: `Vấn đề khác với đơn hàng`,
  otherReason: `Lý do khác`,
  outOfStock: `Hết hàng`,
  overlaysAndPanels: `Overlay và bảng thông tin`,
  packagingAndCovers: `Bao bì và ảnh bìa`,
  pageNotFound: `Không tìm thấy trang`,
  passkey: `Khóa truy cập`,
  passkeys: `Khóa truy cập`,
  password: `Mật khẩu`,
  paymentProcessingFee: `Phí xử lý thanh toán`,
  payments: `Thanh toán`,
  payouts: `Thanh toán`,
  personal: `Cá nhân`,
  ...
  pleaseSubmitTheOrderBy: (...v) => `Vui lòng gửi đơn hàng trước ${v[0]}`,
  ...
  publicInformation: `Công khai`,
  publishOn: (...v) => `Đăng trên ${v[0]}`,
  purchases: `Mua hàng`,
  rankings: `Xếp hạng`,
  reactiveAvatars: `Avatar tương tác`,
  reason: `Lý do`,
  recoveryCode: `Mã phục hồi`,
  recoveryCodes: `Mã phục hồi`,
  recoveryCodesLeft: (...v) => `còn ${v[0]}`,
  referenceSheetsAndComics: `Bảng tham chiếu và truyện tranh`,
  removeFilter: (...v) => `Bỏ bộ lọc: ${v[0]}`,
  ...
  schedulesAndSocialGraphics: `Lịch biểu và đồ họa mạng xã hội`,
  search: `Tìm kiếm`,
  ...
  sellerNet: `Số tiền thực nhận của người bán`,
  ...
  share: `Chia sẻ`,
  sharedFilesAreNotConsideredDelivery: `Tệp đã chia sẻ không được coi là bàn giao`,
  ...
  signIn: `Đăng nhập`,
  signInWithTheDeviceYouAlreadyUnlock: `Đăng nhập bằng thiết bị bạn vẫn mở khóa hằng ngày, và giữ mã phục hồi để dùng khi mất thiết bị`,
  signOutEverywhere: `Đăng xuất trên mọi thiết bị`,
  size: `Kích thước`,
  skip: `Bỏ qua`,
  ...
  suggestACategoryOrSubcategory: `Đề xuất danh mục hoặc danh mục con`,
  supportedFormats: `Định dạng được hỗ trợ:`,
  supportMeOn: `Hãy ủng hộ tôi tại`,
  switchedTo: (...v) => `Đã chuyển sang ${v[0]}`,
  ...
  theBuyerCanSeeTheseFilesRightAway: `Người mua có thể xem các tệp này ngay lập tức`,
  ...
  theSellerCanSeeTheseFilesRightAway: `Người bán có thể xem các tệp này ngay lập tức`,
  theSellerConfirmedYourOrderAndIsWorkingOnIt: `Người bán đã <b>xác nhận</b> đơn hàng của bạn và đang thực hiện`,
  ...
  thumbnailsAndBanners: `Ảnh thu nhỏ và banner`,
  timeConstraints: `Hạn chế thời gian`,
  title: `Tiêu đề`,
  titleYourAddOn: `Đặt tên cho dịch vụ bổ sung của bạn`,
  today: `Hôm nay`,
  ...
  transitionsAndProps: `Hiệu ứng chuyển cảnh và đạo cụ`,
  ...
  usernameLeftAReaction: (...v) => `<b>${v[0]}</b> đã bày tỏ cảm xúc${v[1] ? ` ${v[1]}` : ``}`,
  ...
  useYourFingerprintFaceOrScreenLock: `Dùng dấu vân tay, khuôn mặt hoặc khóa màn hình của bạn`,
  ...
  vocalTuning: `Chỉnh giọng hát`,
  voiceOver: `Lồng tiếng`,
  vote: `Bình chọn`,
  vroidAnd3DAddOns: `Tiện ích bổ sung cho VRoid và 3D`,
  ...
  wellReviewYourSuggestionWithinOneWeekAndLetYouKnowTheOutcome: `Chúng tôi sẽ xem xét đề xuất của bạn trong vòng một tuần và thông báo kết quả cho bạn.`,
  ...
  workDoesNotMatchRequest: `Sản phẩm không đúng với yêu cầu`,
  workIsIncompleteOrFilesAreMissing: `Sản phẩm chưa hoàn chỉnh hoặc thiếu tệp`,
  workIsNotOriginalOrUsesAI: `Tác phẩm không phải nguyên bản hoặc có sử dụng AI`,
  ...
  youCanRequestRemovalOfYourAccount: `Bạn có thể yêu cầu xóa tài khoản của mình cùng với tất cả hồ sơ và dữ liệu của tài khoản`,
  ...
  youDisputedTheOrder: `Đã mở tranh chấp. Kiểm tra Tin nhắn để xem cuộc trò chuyện tranh chấp`,
  ...
  youMustPressSubmitButtonToFinalizeTheOrder: `Bạn phải nhấn nút gửi để hoàn tất đơn hàng`,
  ...
  yourSessionWasEndedPleaseSignInAgain: `Phiên của bạn đã bị kết thúc, vui lòng đăng nhập lại`,
