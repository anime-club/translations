export const text: text = {
  ...
  orderAOneOfAKindCustomPieceCraftedToMatchYourVision: `Đặt một tác phẩm độc bản được sáng tạo theo đúng ý tưởng của bạn`,
  youAreCoveredIfThereIsAProblem: `Bạn được bảo vệ! Nếu có vấn đề và khiếu nại hợp lệ, bạn sẽ được hoàn lại 100% số tiền`,
