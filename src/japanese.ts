export const text: text = {
  ...
  orderAOneOfAKindCustomPieceCraftedToMatchYourVision: `あなたのイメージに合わせた世界に一つだけの作品を注文できます`,
  youAreCoveredIfThereIsAProblem: `安心してご利用ください。問題が発生し、異議申し立てが認められた場合は全額返金されます`,
