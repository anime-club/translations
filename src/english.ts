export const text = {
  ...
  addOns: `Add-ons`,
  addOnsAreOptionalEnhancementsToYourProduct: `Add-ons are optional enhancements to your product`,
  addOnsHelpBoostIncome: `Add-ons help buyers customize their order and can boost your income`,
  addSignInVia: `Add sign in via`,
  addToCart: `Add to cart`,
  adoptable: `Adoptable`,
  advancedOptions: `Advanced options`,
  agreedRevisionsWereNotCompleted: `Agreed revisions were not completed`,
  aiGeneratedImagesAndNeuralNetworkFiltersAreProhibited: `AI-generated images and neural network filters are prohibited`,
  alertsAndWidgets: `Alerts and widgets`,
  all: `All`,
  ...
  anAccountAlreadyUsesThisEmailSignInThenConnect: `An account already uses this email address. Sign in the way you normally do, then connect this provider in your account settings`,
  anAccountAlreadyUsesThisEmailSignInWithPasskeyThenConnect: `An account already uses this email address. Sign in with your passkey, then we'll connect this provider for you`,
  anAccountAlreadyUsesThisEmailSignInWithThenConnect: (providerNames: string) =>
    `An account already uses this email address. Sign in with ${providerNames}, then we'll connect this provider for you`,
  animationAndVideo: `Animation and video`,
  ...
  animeDotclubNeverAsksForYourRecoveryCodes: `Anime.club never asks for your recovery codes`,
  ...
  artworkPublished: `Artwork published`,
  ...
  avatarsAndModels: `Avatars and models`,
  ...
  back: `Back`,
  backgroundAndDesign: `Background and design`,
  badges: `Badges`,
  ...
  cantFindTheRightCategoryTellUsWhatYouWouldLikeUsToAdd: `Can't find the right category? Tell us what you'd like us to add.`,
  cantSignIn: `Can't sign in?`,
  categoryAndSubcategory: `Category and subcategory`,
  categoryAndTerms: `Category and terms`,
  change: `Change`,
  ...
  characterAndChibi: `Character and chibi`,
  chat: `Chat`,
  ...
  chooseTheCategoryAndSubcategoryThatBestDescribeYourProductThenSetClearTermsForBuyers: `Choose the category and subcategory that best describe your product, then set clear terms for buyers.`,
  city: `City`,
  clearAll: `Clear all`,
  ...
  commercialUsePrice: `Commercial use price`,
  ...
  continue: `Continue`,
  continueWithFingerprintOrFace: `Sign in with fingerprint or face`,
  ...
  country: `Country`,
  cover: `Cover`,
  createAddOnsForYourProduct: `Create add-ons for your product`,
  ...
  describeTheDetailsOfYourAddOn: `Describe the details of your add-on`,
  ...
  doNotShareYourRecoveryCodesWithAnyone: `Do not share your recovery codes with anyone`,
  download: `Download`,
  downloadThemBelow: `Download them below`,
  dragAndDropOrSelectFiles: `Drag & Drop or Select file(s)`,
  drawingContest: `Drawing contest`,
  dueDate: `Due date`,
  eachProfileHasItsOwnArtShopAndFollowers: `Each profile has its own art, shop, and followers. One sign-in covers all of them`,
  earlier: `Earlier`,
  ...
  emotesAndStickers: `Emotes and stickers`,
  emotesAndStreamAssets: `Emotes and stream assets`,
  ...
  enterTheAddressAssociatedWithYourAccount: `Enter the address associated with your account, and we'll email you a code to sign in and set up a new passkey`,
  enterYourPassword: `Enter your password`,
  error: `Error`,
  errorPleaseContactCustomerSupport: `Error! Please contact customer support...`,
  eventGraphics: `Event graphics`,
  ...
  files: `Files`,
  filesAreCorruptedOrUnusable: `Files are corrupted or unusable`,
  filesForPreview: `Files for preview`,
  filesForTheBuyer: `Files for buyers to download`,
  ...
  graphicsAndBranding: `Graphics and branding`,
  ...
  ifYouLoseItYoullNeedASecondWayToGetBackIn: `You have one way to sign in. If you lose it, you'll need a second one to get back into your account: add another passkey, or save a set of recovery codes`,
  ...
  legal: `Legal`,
  legalIntro: `Read the legal documents that govern anime.club and explain how personal information is handled`,
  ...
  logoAndBrandDesign: `Logo and brand design`,
  logOut: `Log out`,
  makeSureEverythingIsReadyToGoNoEditsAfterPublishing: `Make sure everything is final because you cannot edit it after publishing`,
  ...
  modelArt2D: `2D model art`,
  models3D: `3D models`,
  monthly: `Monthly`,
  moreFrom: (username: string) => `More from ${username}`,
  musicAndAudio: `Music and audio`,
  musicAndShortFormVideo: `Music and short-form video`,
  mustBeNChars: (num: number) => `Must be ${num} chars`,
  myPayments: `My payments`,
  myProfile: `My profile`,
  mySettings: `My settings`,
  name: `Name`,
  namePasskey: `Name passkey`,
  nameYourDevicesToTellThemApart: `Name your devices to tell them apart`,
  ...
  noteOnlyVisibleToYou: `Note (only visible to you)`,
  notes: `Notes`,
  ...
  offerOptionalAddOns: `Offer optional add-ons like <b>rush delivery</b>, an <b>extra character</b>, or a <b>detailed background</b>`,
  online: `Online`,
  ...
  openDisputeChat: `Open dispute chat`,
  openDisputeGuidance: `Clearly explain what is wrong with the order and what resolution you expect. After you open a dispute, we'll create a group chat with you, the seller, and anime.club support. Both parties can provide evidence there. Support can access the order details and all files already shared with the order.`,
  ...
  originalAnimation: `Original animation`,
  originalMusic: `Original music`,
  otherOrderIssue: `Other order issue`,
  otherReason: `Other reason`,
  outOfStock: `Out of stock`,
  overlaysAndPanels: `Overlays and panels`,
  packagingAndCovers: `Packaging and covers`,
  ...
  pleaseSubmitTheOrderBy: (date: string | number) => `Please submit the order by ${date}`,
  ...
  purchases: `Purchases`,
  rankings: `Rankings`,
  reactiveAvatars: `Reactive avatars`,
  reason: `Reason`,
  recoveryCode: `Recovery code`,
  recoveryCodes: `Recovery codes`,
  recoveryCodesLeft: (count: string | number) => `${count} left`,
  referenceSheetsAndComics: `Reference sheets and comics`,
  ...
  schedulesAndSocialGraphics: `Schedules and social graphics`,
  search: `Search`,
  ...
  share: `Share`,
  sharedFilesAreNotConsideredDelivery: `Shared files are not considered delivery`,
  ...
  signIn: `Sign in`,
  signInWithTheDeviceYouAlreadyUnlock: `Sign in with the device you already unlock, and keep recovery codes in case you lose it`,
  ...
  suggestACategoryOrSubcategory: `Suggest a category or subcategory`,
  supportedFormats: `Supported formats:`,
  supportMeOn: `Support me on`,
  switchedTo: (username: string) => `Switched to ${username}`,
  ...
  thumbnailsAndBanners: `Thumbnails and banners`,
  timeConstraints: `Time constraints`,
  title: `Title`,
  titleYourAddOn: `Title your add-on`,
  today: `Today`,
  ...
  transitionsAndProps: `Transitions and props`,
  ...
  uploadTheFilesYourBuyerWillGet: `Upload the files buyers will download after purchase`,
  ...
  usernameLeftAReaction: (username: string, emoji?: string) =>
    `<b>${username}</b> left a reaction${emoji ? ` ${emoji}` : ``}`,
  ...
  useYourFingerprintFaceOrScreenLock: `Use your fingerprint, face, or screen lock`,
  ...
  vote: `Vote`,
  vroidAnd3DAddOns: `VRoid and 3D add-ons`,
  ...
  wellReviewYourSuggestionWithinOneWeekAndLetYouKnowTheOutcome: `We’ll review your suggestion within one week and let you know the outcome.`,
  ...
  workDoesNotMatchRequest: `Work doesn't match the request`,
  workIsIncompleteOrFilesAreMissing: `Work is incomplete or files are missing`,
  workIsNotOriginalOrUsesAI: `Work is not original or uses AI`,
  ...
  youCanRequestRemovalOfYourAccount: `You can request removal of your account with all its profiles and data`,
  ...
  youDisputedTheOrder: `Dispute opened. Check Messages for the dispute chat`,
  ...
  youMustPressSubmitButtonToFinalizeTheOrder: `You must press the submit button to finalize the order`,
  ...
  yourSessionWasEndedPleaseSignInAgain: `Your session was ended, please sign in again`,
