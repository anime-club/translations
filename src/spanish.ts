export const text: text = {
  ...
  orderAOneOfAKindCustomPieceCraftedToMatchYourVision: `Encarga una obra personalizada y única, creada según tu visión`,
  youAreCoveredIfThereIsAProblem: `¡Estás protegido! Si hay un problema y la disputa es válida, recuperarás el 100% de tu dinero`,
