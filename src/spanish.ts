export const text: text = {
  ...
  forNewMasterpieces: `Para nuevas obras maestras`,
  four04: `— 404! —`,
  ...
  needAtLeast1CharacterFromN: (n) => `Necesita al menos 1 caracter de [${n}]`,
  needNCharacter: (n) => `Debe tener ${n} caracter`,
  ...
  onlyHexNumbersStartsWithTChar: `Solo números hexadecimales [0-9a-fA-F], comienzan con caracter 't'`,
  onlyLatinLettersNumbersOrSpecialSymbols: `Solo letras latinas, números o símbolos especiales`,
  ...
  pleaseTryAgainOrClick: (n) => `Por favor intente de nuevo o clic ${n}`,
  ...
  spaceCharacterIsNotAllowed: `El caracter de espacio no está permitido`,
