export const text: text = {
  ...
  addNewArt: `添加新艺术品`,
  addOns: `附加服务`,
  addOnsAreOptionalEnhancementsToYourProduct: `附加服务是可选的产品增强项`,
  addOnsHelpBoostIncome: `附加服务可让买家定制订单，也能提高您的收入`,
  addSignInVia: `通过添加登录`,
  addToCart: `添加到购物车`,
  adoptable: `可领养角色`,
  advancedOptions: `高级选项`,
  agreedRevisionsWereNotCompleted: `约定的修改未完成`,
  aiGeneratedImagesAndNeuralNetworkFiltersAreProhibited: `禁止使用AI生成的图片和神经网络滤镜`,
  alertsAndWidgets: `提醒与小组件`,
  all: `全部`,
  allDevices: `所有设备`,
  ...
  anAccountAlreadyUsesThisEmailSignInThenConnect: `已有账户使用此电子邮件地址。请按您平常的方式登录，然后在账户设置中连接此提供商`,
  anAccountAlreadyUsesThisEmailSignInWithPasskeyThenConnect: `已有账户使用此电子邮件地址。请使用您的通行密钥登录，我们会为您连接此提供商`,
  anAccountAlreadyUsesThisEmailSignInWithThenConnect: (...v) =>
    `已有账户使用此电子邮件地址。请使用${v[0]}登录，我们会为您连接此提供商`,
  animationAndVideo: `动画与视频`,
  ...
  animeCommunity: `动漫社区`,
  animeDotclubNeverAsksForYourRecoveryCodes: `Anime.club 从不索要您的恢复代码`,
  ...
  cantFindTheRightCategoryTellUsWhatYouWouldLikeUsToAdd: `找不到合适的类别？请告诉我们你希望添加什么。`,
  cantSignIn: `无法登录？`,
  categoryAndSubcategory: `类别与子类别`,
  categoryAndTerms: `类别与条款`,
  change: `更改`,
  changeArt: `改变艺术`,
  changeAvatar: `更改头像`,
  changedMyMind: `改变主意了`,
  ...
  commercialUsePrice: `商业使用价格`,
  commission: `委托`,
  commissionPublished: `委托已发布`,
  commissions: `委托`,
  community: `社区`,
  completed: `已完成`,
  confirmAccount: `确认帐号`,
  ...
  contactUs: `联系我们`,
  continue: `继续`,
  continueWithFingerprintOrFace: `使用指纹或人脸登录`,
  contractTitle: `合同标题`,
  ...
  country: `国家`,
  cover: `封面`,
  createAddOnsForYourProduct: `为您的产品创建附加服务`,
  ...
  deleteShop: `删除店铺`,
  deliveryTime: `交货时间`,
  describeTheDetailsOfYourAddOn: `描述您的附加服务详情`,
  ...
  discard: `放弃`,
  discoverAnimeArtAndArtistsFromAroundTheWorld: `在 Anime.club 探索来自世界各地的动漫艺术和艺术家。关注创作者、支持他们的作品、探索原创艺术，或分享你自己的作品`,
  displayName: `显示名称`,
  disputed: `有争议`,
  documentation: `文档`,
  donations: `捐赠`,
  done: `完成了`,
  doNotShareYourRecoveryCodesWithAnyone: `请勿将您的恢复代码分享给任何人`,
  download: `下载`,
  downloadThemBelow: `在下方下载`,
  dragAndDropOrSelectFiles: `拖放或选择文件`,
  drawingContest: `绘画比赛`,
  dueDate: `截止日期`,
  eachProfileHasItsOwnArtShopAndFollowers: `每个个人资料都有自己的作品、店铺和粉丝。一次登录即可使用全部`,
  earlier: `更早`,
  ...
  ifYouLoseItYoullNeedASecondWayToGetBackIn: `您只有一种登录方式。如果丢失，您需要第二种方式才能重新进入账户：再添加一个通行密钥，或保存一组恢复代码`,
  ...
  leaveAReview: `留下评论`,
  legal: `法律`,
  legalIntro: `阅读管理 anime.club 并说明如何处理个人信息的法律文件`,
  ...
  name: `名称`,
  namePasskey: `命名通行密钥`,
  nameYourDevicesToTellThemApart: `为您的设备命名以便区分`,
  ...
  offerOptionalAddOns: `提供可选附加服务，例如<b>加急交付</b>、<b>额外角色</b>或<b>精细背景</b>`,
  online: `在线`,
  ...
  open: `打开`,
  openDispute: `打开争议`,
  openDisputeChat: `打开争议聊天`,
  openDisputeGuidance: `请清楚说明订单存在的问题以及你期望的解决方案。发起争议后，我们会创建一个包含你、卖家和 anime.club 支持团队的群聊。双方都可以在其中提供证据。支持团队可以查看订单详情以及已在订单中共享的所有文件。`,
  ...
  orderOptions: `订单选项`,
  orderStatus: `订单状态`,
  originalAnimation: `原创动画`,
  originalMusic: `原创音乐`,
  otherOrderIssue: `其他订单问题`,
  otherReason: `其他原因`,
  outOfStock: `缺货`,
  overlaysAndPanels: `直播覆盖层与面板`,
  packagingAndCovers: `包装与封面`,
  pageNotFound: `页面未找到`,
  passkey: `通行密钥`,
  passkeys: `通行密钥`,
  password: `密码`,
  ...
  pleaseSubmitTheOrderBy: (...v) => `请在${v[0]}前提交订单`,
  ...
  promotions: `促销`,
  publicInformation: `公开`,
  publishOn: (...v) => `发布于${v[0]}`,
  purchases: `购买`,
  rankings: `排名`,
  reactiveAvatars: `响应式虚拟形象`,
  reason: `原因`,
  recoveryCode: `恢复代码`,
  recoveryCodes: `恢复代码`,
  recoveryCodesLeft: (...v) => `剩余${v[0]}个`,
  referenceSheetsAndComics: `设定图与漫画`,
  removeFilter: (...v) => `移除筛选：${v[0]}`,
  reorderFiles: `重新排序文件`,
  replies: `回复`,
  reply: `回复`,
  ...
  saveAvatar: `保存头像`,
  saveChanges: `保存更改`,
  schedulesAndSocialGraphics: `日程表与社交媒体图片`,
  search: `搜索`,
  searchProducts: `搜索商品`,
  selectAnime: `选择动漫`,
  ...
  share: `分享`,
  sharedFilesAreNotConsideredDelivery: `共享的文件不视为交付`,
  ...
  signIn: `登入`,
  signInWithTheDeviceYouAlreadyUnlock: `使用您本就会解锁的设备登录，并保存恢复代码以防丢失`,
  signOutEverywhere: `在所有设备上退出`,
  size: `大小`,
  skip: `跳跃`,
  socialMedia: `社交媒体`,
  soundEffects: `音效`,
  ...
  suggestACategoryOrSubcategory: `建议类别或子类别`,
  supportedFormats: `支持的格式：`,
  supportMeOn: `支持我`,
  switchedTo: (...v) => `已切换到${v[0]}`,
  ...
  theBuyerCanSeeTheseFilesRightAway: `买家可以立即看到这些文件`,
  ...
  theSellerCanSeeTheseFilesRightAway: `卖家可以立即看到这些文件`,
  theSellerConfirmedYourOrderAndIsWorkingOnIt: `卖家已<b>确认</b>您的订单，正在处理中`,
  ...
  thumbnailsAndBanners: `缩略图与横幅`,
  timeConstraints: `时间限制`,
  title: `标题`,
  titleYourAddOn: `为您的附加服务命名`,
  today: `今天`,
  ...
  usernameLeftAReaction: (...v) => `<b>${v[0]}</b> 留下了回应${v[1] ? ` ${v[1]}` : ``}`,
  ...
  useYourFingerprintFaceOrScreenLock: `使用您的指纹、人脸或屏幕锁`,
  ...
  wellReviewYourSuggestionWithinOneWeekAndLetYouKnowTheOutcome: `我们会在一周内审核您的建议，并告知您结果。`,
  ...
  workDoesNotMatchRequest: `作品与要求不符`,
  workIsIncompleteOrFilesAreMissing: `作品未完成或文件缺失`,
  workIsNotOriginalOrUsesAI: `作品并非原创或使用了 AI`,
  ...
  youCanRequestRemovalOfYourAccount: `您可以请求删除您的帐户及其所有个人资料和数据`,
  ...
  youDisputedTheOrder: `争议已发起。请在消息中查看争议聊天`,
  ...
  youMustPressSubmitButtonToFinalizeTheOrder: `必须点击提交按钮才能完成订单`,
  ...
  yourSessionWasEndedPleaseSignInAgain: `您的会话已结束，请重新登录`,
