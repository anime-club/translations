export const text: text = {
  ...
  orderAOneOfAKindCustomPieceCraftedToMatchYourVision: `اطلب عملًا فريدًا ومخصصًا ليناسب رؤيتك`,
  youAreCoveredIfThereIsAProblem: `أنت محمي! إذا حدثت مشكلة وثبتت صحة النزاع، فستسترد أموالك كاملة`,
