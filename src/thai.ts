export const text: text = {
  ...
  orderAOneOfAKindCustomPieceCraftedToMatchYourVision: `สั่งผลงานชิ้นพิเศษที่สร้างขึ้นตามจินตนาการของคุณ`,
  youAreCoveredIfThereIsAProblem: `คุณได้รับความคุ้มครอง! หากเกิดปัญหาและข้อโต้แย้งมีมูล คุณจะได้รับเงินคืน 100%`,
